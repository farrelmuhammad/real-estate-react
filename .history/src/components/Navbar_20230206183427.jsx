...
const Navbar = () => {
    return (
        <>
            <nav
                className="sticky top-0 w-full flex flex-wrap items-center justify-between py-1 bg-white text-black shadow-none lg:shadow-md navbar navbar-expand-lg navbar-light px-5 z-40"
            >
